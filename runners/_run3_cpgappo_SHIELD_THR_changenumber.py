...
# R1-C6 点名 θ_risk (SHIELD_THR_HIGH/NORM), 必须补做敏感性
...
EXP_TAG          = "sens_SHIELD_THR"   # 输出目录 CPGAPPO_sens_SHIELD_THR_{ts}
...
SWEEP_PARAMS = [
    ...
    # 只扫 SHIELD_THR_HIGH / SHIELD_THR_NORM (θ_risk, R1-C6 点名)
