...
EXP_TAG          = "sens"   # 输出目录 CPGAPPO_sens_{ts}; 可改成如 "sens_round1"
...
SWEEP_PARAMS = [
    ...
    ("LAMBDA_GUIDE", [0.0, 0.05, 0.1, 0.2, 0.4]),

    ("BONUS_TO",     [-2.0, -4.0, -7.0, -10.0]),

    ("W_E",          [0.0, 0.025, 0.05, 0.1, 0.2]),

    ("W_D",          [0.0, 0.05, 0.1, 0.2, 0.4]),

    # ---- 可选追加 (取消注释即扫) ----

    # ("SHIELD_THR_HIGH", [1.00, 1.05, 1.10, 1.15, 1.20]),

    # ("SHIELD_THR_NORM", [1.05, 1.10, 1.15, 1.20, 1.30]),

    # ("CP_REM_COEFF",    [0.2, 0.3, 0.45, 0.6, 0.8]),

    # ("OVERFLOW_MULT",   [1.0, 1.1, 1.25, 1.5, 2.0]),

    # ("BONUS_FIN",       [1.0, 2.0, 4.0, 6.0, 8.0]),

    # ("TERMINAL_COEF",   [2.0, 3.0, 5.0, 8.0]),
